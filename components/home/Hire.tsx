...
const Hire = () => {
    return (
        <a href="mailto:appolinaireenangnon.adande@centrale-casablanca.ma" target={"_blank"} className="fixed bottom-4 left-4 overflow-hidden max-md:hidden flex items-center justify-center">
