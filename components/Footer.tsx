...
const Footer = () => {
  return (
    <div className="border-t border-gray-300 pt-12 py-6 text-lg font-medium bg-light dark:bg-dark dark:text-light dark:border-light max-sm:text-base">
      <Layout className="flex! justify-between max-lg:flex-col! max-lg:items-center max-lg:justify-center max-lg:py-6">
